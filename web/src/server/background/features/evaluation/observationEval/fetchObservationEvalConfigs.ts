...
export async function fetchObservationEvalConfigs(
  ...
  // Fetch configs from database — includes trace configs so direct
  // OTel observation scheduling can also trigger trace-level evals
  // when processing a root span (parent_span_id = "").
