...
import { TbBrandAzure, TbBrandOauth, TbDatabase } from "react-icons/tb";
...
export const getServerSideProps: GetServerSideProps<PageProps> = async () => {
  // Multi-tenant SSO is an Enterprise Edition feature; OSS never has dynamic SSO providers.
  const sso = false;
  return {
    props: {
      authProviders: {
      ...
      <div>
        ...
        <div className="flex flex-row flex-wrap items-center justify-center gap-2">
          ...
          {authProviders.dorisCloud && (
            <AuthProviderButton
              icon={<TbDatabase className="mr-3" size={18} />}
              label="Doris Cloud"
