...
import { extractObservationVariables } from "@/src/server/background/features/evaluation/observationEval/extractObservationVariables";
import { type ObservationForEval } from "@/src/server/background/features/evaluation/observationEval/types";
import {
