...
import { BatchProjectMediaCleaner } from "@/src/server/background/features/batch-project-media-cleaner";
...
vi.mock("@/src/env.mjs", async () => {
  const actual = await vi.importActual("@/src/env.mjs");
  return {
    env: {
