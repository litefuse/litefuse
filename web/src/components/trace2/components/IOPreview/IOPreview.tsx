          ...
          <div className="relative mx-2 flex flex-col items-start gap-2 rounded-lg border border-dashed p-4">
            ...
            <div className="flex w-full flex-row items-center gap-2 pr-6">
              ...
              <h3 className="text-sm font-semibold">
                {t("Looks like this trace didn't receive an input or output.")}
              </h3>
            </div>
            <p className="text-muted-foreground max-w-sm text-sm">
              {t("Add it in your code to make debugging a lot easier.")}
            </p>
            <ActionButton
              variant="outline"
              size="sm"
              href="https://litefuse.ai/faq/all/empty-trace-input-and-output"
