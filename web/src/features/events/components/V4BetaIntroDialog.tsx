  ...
  return (
    <Dialog open={open} onOpenChange={(o) => !o && onConfirm()}>
      <DialogContent
        ...
        aria-label={t("Welcome to a faster Litefuse")}
      >
        <DialogBody>
          ...
          <img
            ...
            alt={t(
              "Litefuse gets Faster - performance comparison showing 5x to 165x speedups",
            )}
          ...
          <ul className="flex flex-col gap-3">
            <li className="text-muted-foreground text-sm">
              <span className="text-foreground block font-medium">
                {t("Welcome to a faster Litefuse")}
              </span>{" "}
              {t(
            ...
            <li className="text-muted-foreground text-sm">
              ...
              <span className="font-medium">
                {t("Is Root Observation")} &rarr; {t("True")}
              </span>
              .
            </li>
            <li className="text-muted-foreground text-sm">
              <span className="text-foreground block font-medium">
                {t("New Saved Table Views")}
              </span>{" "}
              {t(
        ...
        <DialogFooter className="items-center sm:justify-between">
          ...
          >
            {t("Read the v4 docs")} &rarr;
          </a>
          <Button onClick={onConfirm}>{t("Understood")} &rarr;</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
