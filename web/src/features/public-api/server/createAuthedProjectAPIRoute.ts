...
> = {
   ...
   *
   * This authentication method is ONLY available when NEXT_PUBLIC_LITEFUSE_CLOUD_REGION is not set (self-hosted).
   *
   * @default false
   */
 ...
 * 4. NEXT_PUBLIC_LITEFUSE_CLOUD_REGION must NOT be set (self-hosted instances only)
 *
