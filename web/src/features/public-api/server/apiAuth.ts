...
export class ApiAuthService {
          ...
          if (authHeader.startsWith("Basic ")) {
            ...
            return {
              ...
              scope: {
                ...
                publicKey,
                isIngestionSuspended: finalApiKey.isIngestionSuspended ?? false,
              },
            };
          }
  ...
  private async addApiKeyToRedis(
    ...
    if (!this.redis || env.LITEFUSE_CACHE_API_KEY_ENABLED !== "true") {
      return;
    }
    ...
    try {
      await this.redis.set(
        ...
        "EX",
        env.LITEFUSE_CACHE_API_KEY_TTL_SECONDS, // redis API is in seconds
      );
    } catch (error: unknown) {
