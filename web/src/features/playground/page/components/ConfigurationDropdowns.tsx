    ...
    <div ref={containerRef} className="bg-muted/25 shrink-0 border-b px-3 py-2">
      <div className="flex items-center justify-start gap-2">
        ...
        <Popover>
          ...
          >
            <div className="mb-3">
              <h4 className="mb-1 text-sm font-medium">{t("Tools")}</h4>
              <p className="text-muted-foreground text-xs">
                {t("Configure tools for your model to use.")}
              </p>
            </div>
            {toolsCount > 0 ? (
              <div className="mb-3">
        ...
        <Popover>
          ...
          <PopoverContent className="w-80 p-4" align="start">
            <div className="mb-3">
              ...
              <p className="text-muted-foreground text-xs">
                {t("Configure JSON schema for structured output.")}
              </p>
            </div>
            {structuredOutputSchema ? (
              <div className="mb-3">
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button variant="outline" size="sm" className="h-8 gap-2">
              {getResponsiveContent(t("Variables"), Variable, t("Vars"))}
              {variablesCount > 0 && (
                <Badge variant="secondary" className="h-4 text-xs">
                  {variablesCount}
                </Badge>
          ...
          <PopoverContent className="w-80 p-4" align="start">
            <div className="mb-3">
              <h4 className="mb-1 text-sm font-medium">
                {t("Variables & Message Placeholders")}
              </h4>
              <p className="text-muted-foreground text-xs">
                {t(
            ...
            {variablesCount > 0 ? (
              ...
              <div className="mb-3">
                <p className="text-muted-foreground text-xs">
                  {t("No variables or message placeholders defined.")}
                </p>
              </div>
            )}
          </PopoverContent>
