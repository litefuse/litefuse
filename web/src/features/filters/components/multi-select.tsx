              ...
              <div className="hidden space-x-1 lg:flex">
                {selectedValues.size > labelTruncateCutOff ? (
                  ...
                  getSelectedOptions().map((option) => {
                    const displayValue =
                      option.displayValue ??
                      (option.value === "" ? t("(empty)") : option.value);
                    return (
                      <Badge
                        variant="secondary"
                        key={option.value}
      ...
      <PopoverContent className="w-[200px] p-0" align="center">
        <InputCommand>
          ...
          <InputCommandList>
            ...
            {!isCustomSelectEnabled && (
              <InputCommandEmpty>{t("No results found.")}</InputCommandEmpty>
            )}
            <InputCommandGroup>
                ...
                <>
                  <InputCommandItem key="select-all" onSelect={handleSelectAll}>
                    ...
                    <div className="font-medium">
                      {allSelectedState ? t("Deselect All") : t("Select All")}
                    </div>
                  </InputCommandItem>
                  <InputCommandSeparator />
                </>
              ...
              <InputCommandGroup forceMount={true}>
                ...
                >
                  ...
                  <Input
                    ...
                    placeholder={t("Enter custom value")}
