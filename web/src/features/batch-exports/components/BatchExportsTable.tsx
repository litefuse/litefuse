...
import {
  BatchExportStatus,
  isBatchExportApiDownloadOnlyStatus,
  type BatchExport,
...
export function BatchExportsTable(props: { projectId: string }) {
  ...
  const getStatusLabel = (status: string) => {
    if (isBatchExportApiDownloadOnlyStatus(status)) {
      return "API Only";
    }
          ...
          return (
            <ActionButton
              ...
              onClick={() => {
                ...
                showSuccessToast({
                  title: "API download URL copied",
                  description:
                    "Use this signed URL with curl or another HTTP client.",
                });
              }}
            >
              Copy API URL
