...
This guide walks you through setting up and testing the Litefuse Slack integration for local development.
...
2. Upload the Litefuse icon from `web/public/icon1024.png` as your app's avatar
...
1. Navigate to your Litefuse project settings
...
- **Direct links**: Jump from Slack messages directly to prompts in Litefuse
