...
export const traceView: ViewDeclarationType = {
  ...
  measures: {
    ...
    observationsCount: {
      ...
      description: i18nKey("Unique observations linked to the trace."),
      unit: "observations",
    },
    scoresCount: {
      sql: "uniq(scores.id)",
...
export const observationsView: ViewDeclarationType = {
  ...
  measures: {
    ...
    totalCost: {
      ...
      alias: "totalCost",
      type: "decimal",
      description: i18nKey("Total cost incurred by the observation."),
      unit: "USD",
    },
    timeToFirstToken: {
...
const scoresV2BaseDimensions: DimensionsDeclarationType = {
  sessionId: {
    ...
    alias: "sessionId",
    type: "string",
    description: i18nKey("Identifier of the session."),
    highCardinality: true,
  },
  ...
  userId: {
    ...
    type: "string",
    relationTable: "events_traces",
    description: i18nKey("Identifier of the user."),
    highCardinality: true,
  },
  tags: {
    sql: "events_traces.tags",
    ...
    type: "string[]",
    relationTable: "events_traces",
    description: i18nKey("User-defined tags."),
  },
  traceRelease: {
    sql: "nullIf(events_traces.release, '')",
    alias: "traceRelease",
    type: "string",
    relationTable: "events_traces",
    description: i18nKey("Release version."),
  },
  traceVersion: {
    sql: "nullIf(events_traces.version, '')",
    alias: "traceVersion",
...
const createScoreSpecificDimensions = (
  ...
  timestampMonth: {
    ...
    alias: "timestampMonth",
    type: "string",
    description: i18nKey("Month of the score timestamp in YYYY-MM format."),
  },
  timestampDay: {
    sql: `formatDateTime(${tableAlias}.timestamp, '%Y-%m-%d')`,
    alias: "timestampDay",
    type: "string",
    description: i18nKey("Day of the score timestamp in YYYY-MM-DD format."),
  },
  observationId: {
