/**
 * Shared SQL building utilities for score analytics.
 *
 * Used by both buildEstimateQuery and buildScoreComparisonQuery to construct
 * SQL fragments for filtering and sampling.
 */
