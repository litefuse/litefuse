 ...
 * Transforms Doris query results into heatmap cell data.
 */
...
/**
 * Input data from Doris for numeric heatmap (binned data)
 */
...
/**
 * Input data from Doris for confusion matrix (categorical data)
 */
 ...
 * Useful when the aggregate doesn't return bins with count=0.
 */
