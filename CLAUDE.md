...
```sh
pnpm --filter web run test --testPathPatterns="<pattern>"
```
...
- When writing tests, especially in the **tests**/server directory, ensure that you avoid `pruneDatabase` calls.
