...
vi.hoisted(() => {
  process.env.LITEFUSE_FREE_TIER_USAGE_THRESHOLD_ENFORCEMENT_ENABLED = "true";
});
...
describe("processThresholds", () => {
  ...
  describe("enforcement feature flag", () => {
    it("tracks usage but does not enforce when LITEFUSE_FREE_TIER_USAGE_THRESHOLD_ENFORCEMENT_ENABLED is false", async () => {
      // Temporarily set enforcement to disabled
      const originalEnv =
        process.env.LITEFUSE_FREE_TIER_USAGE_THRESHOLD_ENFORCEMENT_ENABLED;
      process.env.LITEFUSE_FREE_TIER_USAGE_THRESHOLD_ENFORCEMENT_ENABLED =
        "false";
    ...
    it("enforces thresholds when LITEFUSE_FREE_TIER_USAGE_THRESHOLD_ENFORCEMENT_ENABLED is true", async () => {
