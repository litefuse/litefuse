...
export const observationsTableCols: ColumnDefinition[] = [
  ...
  },
  {
    ...
    id: "toolNames",
    type: "arrayOptions",
    internal: "", // Doris-only; resolved at SQL build time via tool_definitions map keys
    options: [], // to be added at runtime
    nullable: true,
  },
  {
    ...
    id: "calledToolNames",
    type: "arrayOptions",
    internal: "", // Doris-only; resolved at SQL build time via tool_call_names
    options: [], // to be added at runtime
    nullable: true,
  },
  {
    ...
    id: "toolDefinitions",
    type: "number",
    internal: "", // Doris-only; resolved at SQL build time
    nullable: true,
  },
  {
    name: "Tool Calls",
