 ...
 * The {paramName: Type} placeholder syntax matches the upstream query
 * interface for source-level compatibility with imported queries; values
 * are formatted to Doris-compatible SQL literals.
 */
export class DorisParameterProcessor {
  /**
   * Process query with parameters
   * @param query SQL query with {paramName: Type} placeholders
  ...
  /**
   * Format parameter value based on the type annotation.
   * @param value The parameter value
   * @param typeInfo Type label like "Array(String)", "String", "DateTime64(3)"
