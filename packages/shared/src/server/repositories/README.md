...
### Guarantees for relating data within Litefuse

- Finding a Trace based on an observation [Linear](https://linear.app/litefuse/issue/LFE-2745/improve-generations-table-query-performance)
...
- Finding an Observation based on a Trace [Linear](https://linear.app/litefuse/issue/LFE-2409/table-queries)
