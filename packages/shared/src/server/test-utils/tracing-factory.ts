...
export const createEvent = (
  event: Partial<EventRecordInsertType> & {
    /** Convenience override: object form, flattened into the parallel arrays. */
  ...
  // Extract metadata overrides (object-form + parallel-array form) before
  // spreading to prevent undefined from clobbering defaults.
  const {
    metadata: metadataObjectOverride,
    metadata_values: metadataValuesOverride,
  ...
  return {
    ...
    metadata_values: metadataValuesOverride ?? metadataValues,
